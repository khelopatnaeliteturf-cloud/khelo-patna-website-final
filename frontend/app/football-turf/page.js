...
/* ───────── data ───────── */
const FEATURES = [
  "FIFA-Grade Artificial Grass Surface",
  "Fully Enclosed Safety Netting",
  "Shock-Absorbing Underpad System",
  "High-Power LED Floodlights",
  "Free Bibs & Training Cones",
];
...
const OCCASIONS = [
  {
    ...
    desc: "Gather your squad for high-energy 5v5 or 7v7 matches on a world-class surface.",
  },
  {
    icon: "shield",
    title: "Team Practice",
    desc: "Run structured drills and practice sessions with full field access and equipment.",
  },
  {
    icon: "emoji_events",
    title: "Corporate & Tournaments",
    desc: "Organize corporate leagues and knockout tournaments with professional amenities.",
  },
];

/* ───────── component ───────── */
export default function FootballTurfPage() {
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 36 }}>
          ...
          <Link href="/book" className="btn-premium" style={{ padding: "10px 26px", fontSize: "0.85rem" }}>
            Book Slot
          </Link>
        </div>
      </nav>
      ...
      <main style={{ paddingTop: 72 }}>
        ...
        >
          ...
          <span className="section-eyebrow">Pro-Grade Turf Arena</span>
          ...
          >
            <span className="material-icons-outlined" style={{ fontSize: '32px', marginRight: '8px', verticalAlign: 'middle', color: 'var(--neon)' }}>sports_soccer</span> FOOTBALL{" "}
            <span
              style={{
          ...
          >
            Fast Turf. Fair Play. Fierce Matches.
          </p>
