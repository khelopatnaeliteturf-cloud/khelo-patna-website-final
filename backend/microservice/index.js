    ...
    try {
        ...
        sock.ev.on('messages.upsert', async (m) => {
            ...
            for (const message of m.messages) {
                ...
                console.log(`[Baileys Microservice] Forwarding chat from ${phone} to main site...`);
                try {
                    await axios.post(`${MAIN_BACKEND_URL.replace(/\/+$/, '')}/api/reports/whatsapp/webhook`, {
                        phone,
                        text,
...
// Middleware: Secret authentication for API endpoints
